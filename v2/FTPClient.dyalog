...
⍝ --- Public Methods ---
    ...
    ∇ r←List Dir
      :Access Public   ⍝ Get list of files in directory
      r←GetData'A'('NLST ',Dir)
    ∇
    
    ∇ r←Get File
      :Access Public   ⍝ Get file in Ascii Mode
      r←GetData'A'('RETR ',File)
    ∇
    
    ∇ r←Put(File Data)
      :Access Public   ⍝ Store file in Ascii Mode
      r←PutData'A'('STOR ',File)Data
    ∇
    
    ∇ r←GetBin File
      :Access Public   ⍝ Get file in Binary Mode
