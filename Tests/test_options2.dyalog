 r←test_options2 dummy;WSAutoUpgrade;RawAsByte;DecodeHttp;RawAsInt;ops;modes;m;o;Port;Srv;Clt;Host;ret;exp;err;srv;r2;clt;o∆;applicable;o∆;EnableFifo
⍝∇Test: group=Basic
⍝ Test fundamental Conga functionality
 ...
 DecodeHttp←4
 EnableFifo←32
 ops←WSAutoUpgrade RawAsByte DecodeHttp EnableFifo
 m←o←'(undefined)'
 ...
 :For m :In modes
     :For o :In {⍵+.×((≢⍵)/2)⊤¯1+⍳(≢⍵)*2}ops
         ...
         applicable←(o<EnableFifo)∧(o=0)∨((m≡'http')∧~⊃2 2⊤o)∨(o=2)∧(⊂m)∊'Raw' 'BlkRaw' ⍝ can this option be set for current mode? (assuming 2 needs [Blk]Raw (or http! *undocumented*) and everything else http)
